...
const TX = {
  de: {
    ...
    tokenHint: 'Ihr Token wird auf Ihrer privaten Instanz gespeichert — nicht in einem gemeinsamen Kundensystem.',
    ...
    keyHint: 'Ihr Schlüssel wird auf Ihrer privaten Instanz gespeichert — nicht in einem gemeinsamen Kundensystem.',
  ...
  en: {
    ...
    tokenLabel: (ch: string) => ch === 'telegram' ? 'Telegram bot token *' : 'Discord bot token *',
    tokenHint: 'Your token is stored on your private instance — not in a shared customer system.',
    ...
    keyLabel: 'API key *',
    keyHint: 'Your key is stored on your private instance — not in a shared customer system.',
